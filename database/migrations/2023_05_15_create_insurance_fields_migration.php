...
class CreateInsuranceFieldsMigration extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('datapasien', function (Blueprint $table) {
            // Check and add no_bpjs column if it doesn't exist
            if (!Schema::hasColumn('datapasien', 'no_bpjs')) {
                $table->string('no_bpjs')->nullable();
            }
            
            // Check and add scan_bpjs column if it doesn't exist
            if (!Schema::hasColumn('datapasien', 'scan_bpjs')) {
                $table->string('scan_bpjs')->nullable();
            }
            
            // Check and add scan_asuransi column if it doesn't exist
