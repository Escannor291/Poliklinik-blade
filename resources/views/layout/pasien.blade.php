    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard-pasien') }}">
                ...
                <div class="sidebar-brand-text mx-3">Fachri Hospital</div>
            </a>
            ...
            <!-- Nav Item - Data Diri -->
            <li class="nav-item {{ request()->is('datapribadi*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ Auth::user()->datapasien ? route('pasien.show', Auth::user()->datapasien->id) : '#' }}">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                @if(Auth::user()->foto_user)
                                    <img class="img-profile rounded-circle" src="{{ asset('storage/foto_user/' . Auth::user()->foto_user) }}">
                                @else
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Fachri Hospital 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
